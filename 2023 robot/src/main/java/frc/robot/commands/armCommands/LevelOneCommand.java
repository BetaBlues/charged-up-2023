...
public class LevelOneCommand extends CommandBase {
    ...
    public LevelOneCommand(extenderSubsystem extenderSub, shoulderSubsystem shoulderSub) {
      ...
      @Override
      public void execute() {
        shoulderSub.levelOne(shoulderSub.getPosition());
        extenderSub.levelOne(extenderSub.getPosition());
      }
